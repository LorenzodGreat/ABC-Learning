<div>
    <header class="shadow-sm">
      ...
      <h1  class="text-xl text-white font-large space-x-8 md:flex">ABC LEARNING ACADEMY</h1>
            ...
            <div class="items-center justify-end flex-1 hidden space-x-4 sm:flex">
              <a class="px-5 py-2 text-sm font-medium text-gray-500 bg-gray-100 rounded-lg" href="/login"> Log in </a>
      
              <a class="px-5 py-2 text-sm font-medium text-white bg-blue-600 rounded-lg" href="/register"> Sign up </a>
            </div>
