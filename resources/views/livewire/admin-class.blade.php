            ...
            >
              <table class="min-w-full divide-y divide-gray-200">
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    @foreach ($learn as $code)
                  <tr>
                    <td class="px-6 py-4 whitespace-nowrap">
                      <div class="flex items-center">
                        <div class="ml-4">
                          <div class="text-sm font-medium text-gray-900">
                            {{ $code->teachers->full_name }}
                          </div>
                        </div>
                      </div>
                    </td>
                    ...
                    <td
                      ...
                      "
                    >
                      <a wire:click.prevent ="edit({{ $code->id }})" class="text-indigo-600 hover:text-indigo-900"
                        >Edit</a
                      >
                      <a wire:click.prevent ="delete({{ $code->id }})" class="text-indigo-600 hover:text-indigo-900"
                        >Delete</a
                      >
                    </td>
                  </tr> 
...
<div class="px-4 py-16 mx-auto max-w-screen-xl sm:px-6 lg:px-8">
  <div class="max-w-lg mx-auto">
    <h1 class="text-2xl font-bold text-center text-indigo-600 sm:text-3xl">Add New Teacher Today</h1>
    ...
    <form action="" class="p-8 mt-6 mb-0 rounded-lg shadow-2xl space-y-4">
      ...
      <div class="relative mt-1">
        ...
        <label for="" class="text-sm mt-4 font-medium">Class Teacher</label>
      <div class="relative mt-1">
