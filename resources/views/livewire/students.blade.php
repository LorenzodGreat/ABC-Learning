                  ...
                  <tr>
                    ...
                    >
                      ...
                      <a wire:click.prevent ="delete({{ $items->id }})" class="text-indigo-600 hover:text-indigo-900"
                        >Delete</a
                      >
                      <a wire:click.prevent ="update({{ $items->id }})" class="text-indigo-600 hover:text-indigo-900"
                        >Update</a
                      >
                    </td>
                  </tr> 
...
<div class="px-4 py-16 mx-auto max-w-screen-xl sm:px-6 lg:px-8">
  <div class="max-w-lg mx-auto">
    <h1 class="text-2xl font-bold text-center text-indigo-600 sm:text-3xl">Add New Student Today</h1>
