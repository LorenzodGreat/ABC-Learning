...
<body style="background-image:url('img/abc.jpg');">
    ...
    <div class=" p-3 space-y-2 w-60 bg-white text-gray-800">
        <div class="flex items-center p-2 space-x-4">
          ...
          />
          <div>
            <h2 class="text-lg font-semibold">Welcome Administrator</h2>
          </div>
        </div>
        <div class="divide-y divide-gray-300">
          <ul class="pt-2 pb-4 space-y-1 text-sm">
            ...
            <li>
              <a href="{{ route('courses') }}" class="flex items-center p-2 space-x-3 rounded-md">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 512 512"
                  class="w-5 h-5 fill-current text-gray-600"
            ...
            <li>
              <a href="{{ route('teachers') }}" class="flex items-center p-2 space-x-3 rounded-md">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 512 512"
                  class="w-5 h-5 fill-current text-gray-600"
            ...
            <li>
              <a href="/students" class="flex items-center p-2 space-x-3 rounded-md">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 512 512"
                  class="w-5 h-5 fill-current text-gray-600"
            ...
            <li>
              <a href="{{ route('class') }}" class="flex items-center p-2 space-x-3 rounded-md">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 512 512"
                  class="w-5 h-5 fill-current text-gray-600"
          ...
          <ul class="pt-4 pb-2 space-y-1 text-sm">
            ...
            <li>
              <a href="{{ route('admin-logout') }}" class="flex items-center p-2 space-x-3 rounded-md">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 512 512"
                  class="w-5 h-5 fill-current text-gray-600"
