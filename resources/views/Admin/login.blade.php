<!DOCTYPE html>
<html lang="en" style="background-image: url('https://image.freepik.com/free-vector/white-abstract-background-design_23-2148825582.jpg')">
<head>
    <meta charset="UTF-8">
                ...
                <div class="flex w-full rounded-lg xl:w-3/4 lg:w-11/12 lg:shadow-xl ">
                    <div
                        ...
                        <div class="relative z-10 m-12 text-left ">
                            ...
                            <img src="https://image.freepik.com/free-vector/settings-concept-illustration_114360-3754.jpg" alt="">
                        </div>
                    </div>
                    <div
                        ...
                        <div class="relative z-10 text-left ">
                            ...
                            <form class="mt-6" action={{ route('adminlogin') }} method="POST">
                                @csrf
                                <div class="mt-4">
                                    <h1 class="mb-8 text-2xl font-black tracking-tighter text-black md:text-5xl title-font">Welcome to the ABC Learning Admin Portal. </h1>
